...
requests, discussions, and any project chat), and when an individual is
officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers via `SECURITY.md`'s contact process (the same
channel currently doubles as the general private contact point until a
dedicated conduct address exists). All complaints will be reviewed and
