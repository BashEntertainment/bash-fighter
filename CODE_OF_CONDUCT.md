...
in the Bash Fighter project a harassment-free experience for everyone,
...
- Giving and gracefully accepting constructive feedback, especially on
  code review.
...
requests, discussions, and any project chat) and also applies when an
individual is officially representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported by opening an issue on this repository. If the report itself
needs to stay private (for example because it names another contributor),
say so in the issue title without details, and a maintainer will follow up
through a private channel. We have no public email address for reports;
the repository's issue tracker is the contact point.
